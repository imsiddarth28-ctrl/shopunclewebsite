...
export function TwistingRibbon({
  ...
  useEffect(() => {
    ...
    const L_COLOR_FACE = lightColors?.face ? hexToRgb(lightColors.face) : [212, 135, 64]; // Match primary-500 #d48740
    const L_COLOR_FOLD_A = lightColors?.foldA ? hexToRgb(lightColors.foldA) : [196, 107, 45]; // Match primary-600 #c46b2d
    const L_COLOR_FOLD_B = lightColors?.foldB ? hexToRgb(lightColors.foldB) : [34, 197, 94]; // Match green-500 #22c55e
    const L_COLOR_FOLD_C = lightColors?.foldC ? hexToRgb(lightColors.foldC) : [14, 165, 233]; // Match sky-500 #0ea5e9
    ...
    const D_COLOR_FACE = darkColors?.face ? hexToRgb(darkColors.face) : [212, 135, 64];
    const D_COLOR_FOLD_A = darkColors?.foldA ? hexToRgb(darkColors.foldA) : [196, 107, 45];
    const D_COLOR_FOLD_B = darkColors?.foldB ? hexToRgb(darkColors.foldB) : [34, 197, 94];
    const D_COLOR_FOLD_C = darkColors?.foldC ? hexToRgb(darkColors.foldC) : [14, 165, 233];
